...
export default {
    ...
    methods:{
        async postRequest(){
            this.formErrors = '';
            this.formErrors = await this.userStore.register(this.formData);
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="w-full relative">
                                ...
                                /><label
                                    ...
                                    >Name</label
                                >
                                <div v-if="formErrors.name" class="text-xs font-bold text-red-600">{{ formErrors.name[0] }}</div>
                            </div>
                            <div class="w-full relative">
                                <input
                                    id="contact"
                                    name="contact"
                                    :placeholder="isFocus ? '+994-50-666-66-66' : ' ' "
                                ...
                                /><label
                                    ...
                                    >Contact</label
                                >
                                <div v-if="formErrors.contact" class="text-xs font-bold text-red-600">{{ formErrors.contact[0] }}</div>
                            </div>
                            <div class="w-full relative">
                                <input
                                    id="email"
                                ...
                                /><label
                                    ...
                                    >Email</label
                                >
                                <div v-if="formErrors.email" class="text-xs font-bold text-red-600">{{ formErrors.email[0] }}</div>
                            </div>
                            <div class="w-full relative">
                                <input
                                    id="password"
                                ...
                                /><label
                                    ...
                                    >Password</label
                                >
                                <div v-if="formErrors.password" class="text-xs font-bold text-red-600">{{ formErrors.password[0] }}</div>
                            </div>
                        </div>
                    </div>
                            ...
                            >
                                <p>
                                    Already have an account?<span
                                        class="text-neutral-900 dark:text-zinc-100 cursor-pointer hover:underline" @click="$emit('closeRegister'), $emit('openLogin')"
                                    >
                                        Log in</span
                                    >
                                </p>
